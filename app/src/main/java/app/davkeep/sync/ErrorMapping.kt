...
import app.davkeep.error.certificateUnavailable
import app.davkeep.error.credentialsUnreadable
import app.davkeep.error.malformedResponse
import app.davkeep.error.noCertificateSent
import app.davkeep.net.ClientCertificateUnavailableException
